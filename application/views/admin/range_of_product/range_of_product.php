        ...
        <div class="tab-pane <?= $active == 1 ? 'active' : ''; ?>" id="manage">
            ...
            <div class="panel panel-custom">
                <header class="panel-heading ">
                    <div class="panel-title"><strong>All Range Of Product</strong></div>
                </header>
                <?php } ?>
                    ...
                    <table class="table table-striped DataTables bulk_table" id="DataTables" cellspacing="0" width="100%">
                        ...
                        <script type="text/javascript">
                            $(document).ready(function () {
                                list = base_url + "admin/range_of_product/range_of_productlist";
                                bulk_url = base_url + "admin/range_of_product/bulk_delete";
                            });
                        </script>
                    </table>
                </div>
            ...
            <?php if (!empty($created) || !empty($edited)) { ?>
                <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="create">
                    <form role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" id="form"
                          action="<?php echo base_url(); ?>admin/range_of_product/save_product/<?php
                          if (!empty($RProduct_info)) {
                              echo $RProduct_info->id;
                          }
